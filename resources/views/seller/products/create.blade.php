...
<div class="max-w-3xl mx-auto bg-white shadow-lg rounded-lg p-8 mt-10 border border-gray-300">
    <h1 class="text-2xl font-bold text-gray-800 mb-6 border-b pb-3">🛒 Tambah Produk Baru</h1>
    ...
    <form action="{{ route('seller.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            ...
            <p class="text-xs text-gray-400 mt-1">Format yang didukung: JPG, PNG, JPEG.</p>
        </div>
